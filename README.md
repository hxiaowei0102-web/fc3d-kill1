...
2. 最新200期暴力穷举（5万+公式去重后4.7万条）→ 百/十/个各选1条最优杀码公式
...
| fetch.py | 多源降级抓取 |
| engine.py / formulas.py | 数据引擎 / 公式库 |
| bruteforce.py / backtest.py | 暴力穷举 / 200期回测 |
| gen_site.py | 生成网页 |
| .github/workflows/update.yml | Actions 三重cron定时任务 |
